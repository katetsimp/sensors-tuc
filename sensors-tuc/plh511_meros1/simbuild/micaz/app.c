...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f578c228cf8, const void *arg_0x7f578c227020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f578c1a7618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f578bf5e020), 
int (*key_eq_fn)(void *arg_0x7f578bf5e798, void *arg_0x7f578bf5ea38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f578bd5a610, int arg_0x7f578bd5a878);
static double RandomUniform(void );
...
static inline void SRTreeC__InitializeMaxCountAr(void );
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f578b8faa90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f578b8faa90) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f578b8faa90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f578b8f9670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f578b8f9670, msg, payload, len);
#line 78
...
#line 781
              ...
              sim_log_debug(102U, "SRTreeC", "Now the node %d have a perent with parentID %d and currentdepth %d", TOS_NODE_ID, SRTreeC__parentID[sim_node()], SRTreeC__curdepth[sim_node()]);
            }
          else 
            {
...
#line 833
  ...
  sim_log_debug(106U, "SRTreeC", "receiveMessTask(): len=%u \n", len);
              ...
              if (__nesc_ntoh_uint16(SRTreeC__Children[sim_node()][j].ChID.nxdata) == 0) 
                {
                  ...
                  sim_log_debug(107U, "SRTreeC", "New child");
                }
              if (SRTreeC__choice[sim_node()][0] == MAX) 
                {
                  __nesc_hton_uint8(SRTreeC__Children[sim_node()][j].max.nxdata, __nesc_ntoh_uint8(((Onemessage *)m1)->m.nxdata));
                  sim_log_debug(108U, "Measurements", "Received from Child :%d max:%d", __nesc_ntoh_uint16(SRTreeC__Children[sim_node()][j].ChID.nxdata), __nesc_ntoh_uint8(SRTreeC__Children[sim_node()][j].max.nxdata));
                }
              else 
                {
                  __nesc_hton_uint8(SRTreeC__Children[sim_node()][j].count.nxdata, __nesc_ntoh_uint8(((Onemessage *)m1)->m.nxdata));
                  sim_log_debug(109U, "Measurements", "Received from Child :%d count:%d", __nesc_ntoh_uint16(SRTreeC__Children[sim_node()][j].ChID.nxdata), __nesc_ntoh_uint8(SRTreeC__Children[sim_node()][j].count.nxdata));
                }
              break;
            }
        }
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f578b901970, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f578b901970, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f578b386990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f578b386990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f578b386990, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f578bc34108){
#line 75
  switch (arg_0x7f578bc34108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f578bc34108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f578b385c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f578b385c70, addr, msg, len);
#line 80
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f578b42e2f8){
#line 83
  switch (arg_0x7f578b42e2f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f578b42e2f8);
#line 83
      break;
#line 83
    }
  ...
  switch (operation) 
    {
      ...
      for (j = 0; j < MAX_Ch && __nesc_ntoh_uint16(SRTreeC__Children[sim_node()][j].ChID.nxdata) != 0; j++) {
          sim_log_debug(116U, "calculations", "child %d has max %d\n", __nesc_ntoh_uint16(SRTreeC__Children[sim_node()][j].ChID.nxdata), __nesc_ntoh_uint8(SRTreeC__Children[sim_node()][j].max.nxdata));
      ...
      sim_log_debug(117U, "calculations", "the max is %d\n", result);
      break;
      case COUNT: 
        result = 1;
      for (j = 0; j < MAX_Ch && __nesc_ntoh_uint16(SRTreeC__Children[sim_node()][j].ChID.nxdata) != 0; j++) {
          sim_log_debug(118U, "calculations", "child %d has count %d\n", __nesc_ntoh_uint16(SRTreeC__Children[sim_node()][j].ChID.nxdata), __nesc_ntoh_uint8(SRTreeC__Children[sim_node()][j].count.nxdata));
          result += __nesc_ntoh_uint8(SRTreeC__Children[sim_node()][j].count.nxdata);
        }
      sim_log_debug(119U, "calculations", "the count is %d\n", result);
      break;
      default: 
        return 0;
    }
